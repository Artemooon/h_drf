...
urlpatterns = [
    ...
    path('game-category/<int:id>/', views.GameCategoryDetails.as_view(), name="game_categories"),
    path('games-by-category/<slug:category>/', views.GamesByCategory.as_view(), name="get_game_category_by_game")
]
